...
export const Footer = () => {
  return (
    <footer className="w-full h-[20rem] flex items-center justify-center bg-base">
      <div className="container mx-auto grid grid-cols-5 items-start gap-4">
        <div className="col-span-2 flex flex-col items-start justify-start gap-2">
          ...
          <div className="col-span-1 flex items-center justify-center gap-2 mt-2">
